...
CREATE TABLE `enrollments` (
  ...
  `status`      ENUM('submitted','requirements_incomplete','documents_under_review','assessed_for_payment','awaiting_payment','paid_for_registrar','enrolled','returned','archived','pending','approved','rejected') NOT NULL DEFAULT 'submitted',
